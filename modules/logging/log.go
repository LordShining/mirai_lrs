...
func logGroupMessage(msg *message.GroupMessage) {
	...
	// 	}
	// }
	// if msg.GroupCode == 721023753 && isAtMe {
	// 	bot.Instance.QQClient.SendGroupMessage(721023753, &message.SendingMessage{
	// 		Elements: []message.IMessageElement{
	// 			&message.TextElement{Content: "@" + msg.Sender.DisplayName() + " Test replay"},
	// 		},
	// 	})
